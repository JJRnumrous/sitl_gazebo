...
typedef const boost::shared_ptr<const geometry_msgs::msgs::PoseStamped> GzPoseStampedMsgPtr;
...
class GazeboRosInterfacePlugin : public WorldPlugin {
 ...
 private:
  ...
  // PoseStamped
  void GzPoseStampedMsgCallback(GzPoseStampedMsgPtr& gz_pose_msg,
      ros::Publisher ros_publisher);
  geometry_msgs::PoseStamped ros_pose_msg_;
